...
var handleSuccess = function (stream) {
    ...
    var transfind = new TransientFinder(global, { decay: 60, exponential:true});

    if(window){
        // var public={};
        window.transients=transfind;
        var event = new Event('soundprocessready');
        // Dispatch the event.
